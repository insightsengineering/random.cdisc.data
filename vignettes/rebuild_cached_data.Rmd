...
cadsl_new <- radsl(N= 10, seed = 1, na_vars = list()) %>% `attr<-`("creation date", Sys.Date())
...
load(file.path(system.file(package = "random.cdisc.data"), "data/data_for_adqlqc/eortc_qlq_c30.rda"))
load(file.path(system.file(package = "random.cdisc.data"), "data/data_for_adqlqc/gdsr_param_adqlqc.rda"))
load(file.path(system.file(package = "random.cdisc.data"), "data/data_for_adqlqc/expect.rda"))
cadqlqc_new <- radqlqc(cadsl_new, percent = 80, number = 2) %>% `attr<-`("creation date", Sys.Date())
