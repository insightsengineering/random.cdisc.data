...
load(file.path(system.file(package = "random.cdisc.data"), "data/eortc_qlq_c30.rda"))
load(file.path(system.file(package = "random.cdisc.data"), "data/gdsr_param_adqlqc.rda"))
load(file.path(system.file(package = "random.cdisc.data"), "data/expect.rda"))
