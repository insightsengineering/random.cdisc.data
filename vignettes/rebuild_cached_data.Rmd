...
load(file.path(system.file(package = "random.cdisc.data"), "extdata/eortc_qlq_c30.rda"))
load(file.path(system.file(package = "random.cdisc.data"), "extdata/gdsr_param_adqlqc.rda"))
load(file.path(system.file(package = "random.cdisc.data"), "extdata/expect.rda"))
